...
const projects = [
  ...
  { title: 'Adhikaar AI', meta: 'Voice-first public benefits navigator', description: 'A voice-led AI agent that matches people to welfare schemes and helps them apply.', tech: ['AI', 'Voice UI', 'Playwright'], image: '/assets/project-adhikaar.svg', url: 'https://project-z1e1d.vercel.app/', color: 'yellow' },
...
function Header({ navigate }) {
  return <header className="site-header"><button className="brand" onClick={() => navigate('/')} aria-label="Go home"><b>D</b><b>E</b><b>V</b><i>.</i></button><nav><button onClick={() => navigate('/')}>work</button><button onClick={() => navigate('/about')}>about</button><button onClick={() => navigate('/skills')}>skills</button><button onClick={() => navigate('/projects')}>projects</button><button onClick={() => navigate('/achievements')}>achievements</button><button onClick={() => navigate('/contact')}>contact</button></nav><div className="header-socials"><div className="linkedin-wrap"><a className="linkedin-button header-social" href="https://www.linkedin.com/in/deveshkumar226022/" target="_blank" rel="noreferrer" aria-label="Devesh Kumar on LinkedIn" title="LinkedIn"><i className="fa-brands fa-linkedin-in" /></a><a className="linkedin-popover" href="https://www.linkedin.com/in/deveshkumar226022/" target="_blank" rel="noreferrer"><img src="/assets/DevPp.jpeg" alt="Devesh Kumar" /><strong>Devesh Kumar</strong><span>Product Builder · Creative Technologist</span><b>Connect on LinkedIn <i>↗</i></b></a></div><a className="header-social instagram-header" href="https://instagram.com/dev_decoder" target="_blank" rel="noreferrer" aria-label="Devesh Kumar on Instagram" title="Instagram"><i className="fa-brands fa-instagram" /></a><a className="header-social x-header" href="https://x.com/Devesh16022" target="_blank" rel="noreferrer" aria-label="Devesh Kumar on X" title="X"><i className="fa-brands fa-x-twitter" /></a><a className="header-social github-header" href="https://github.com/Devdk123" target="_blank" rel="noreferrer" aria-label="Devesh Kumar on GitHub" title="GitHub"><i className="fa-brands fa-github" /></a></div></header>
}
